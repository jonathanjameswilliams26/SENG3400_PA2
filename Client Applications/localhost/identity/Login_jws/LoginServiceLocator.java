...
public class LoginServiceLocator extends org.apache.axis.client.Service implements localhost.identity.Login_jws.LoginService {
    ...
    public localhost.identity.Login_jws.Login getLogin() throws javax.xml.rpc.ServiceException {
    ...
    public localhost.identity.Login_jws.Login getLogin(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            localhost.identity.Login_jws.LoginSoapBindingStub _stub = new localhost.identity.Login_jws.LoginSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (localhost.identity.Login_jws.Login.class.isAssignableFrom(serviceEndpointInterface)) {
                localhost.identity.Login_jws.LoginSoapBindingStub _stub = new localhost.identity.Login_jws.LoginSoapBindingStub(new java.net.URL(Login_address), this);
                _stub.setPortName(getLoginWSDDServiceName());
                return _stub;
            }
        }
